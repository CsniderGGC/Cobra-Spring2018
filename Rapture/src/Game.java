...
//======== Bottom Floor METHODS ====================================================================================================================
		
			public void bottomFloor() {
			position = "bottomFloor";
			mainTextArea.setText("This is the bottom floor.");
			choice1.setText("Go Back To Starting Room");
			choice2.setText("");
			choice3.setText("");
			choice4.setText("");
...
//-----------------------------------------------------------------------------------------------------------------------------
	...
	public void room3() {
		position = "room3";
		mainTextArea.setText("ROOM 3: \n\nThe shades of the window have been lowered and a dead patient"
				+ "\nlies in their bed as well as a dead security guard lay-ing on the floor. "
				+ "\nA bag rests on the table containing numerous items. "
...
//-----------------------------------------------------------------------------------------------------------------------------	
				public void room10() {
					...
					choice2.setText("Go to Next Room");
					choice3.setText("");
					choice4.setText("");
					choice5.setText("");
...
//-----------------------------------------------------------------------------------------------------------------------------	
				public void room12() {
					...
					choice1.setText("Go to Previous Room");
					choice2.setText("Go to Hallway");
					choice3.setText("Go to Next Room");
					choice4.setText("");
					choice5.setText("");
...
//-----------------------------------------------------------------------------------------------------------------------------	
				public void room21() {
					...
					choice1.setText("Go to Top Floor");
					choice2.setText("Go to Bottom Floor");
					choice3.setText("");
					choice4.setText("");
					choice5.setText("");
...
//=========ROOM CASES ===========================================================
			...
			case "room14":
				switch(yourChoice) {
				case "C1" : room13();break;
				case "C2" : hallWay();break;
				case "C3" : room15();break;
				case "C4" : break;
				case "C5" : break;
				}
				break;
			...
			case "room23":
				switch(yourChoice) {
				case "C1" : room22();break;
				case "C2" : room24();break;
				case "C3" : break;
				case "C4" : break;
				case "C5" : break;
				}
