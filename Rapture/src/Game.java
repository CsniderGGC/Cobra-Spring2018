...
//-----------------------------------------------------------------------------------------------------------------------------	
	public void room4() {
		...
		mainTextArea.setText("ROOM 4: \n\nThis room is clean and vacant. Containing one bed, two dressers."
				+ " No windows and is very dark. Only light coming into the room is from under the door leading to the hallway. "
				+ "However, there are noises coming from the corner. "
				+ "There is a technician in the corner breathing heavily. Must attack technician to proceed." );
